<!DOCTYPE html>
        ...
        <body>
                   ...
                   <button id="myBtn"><i class="fa-solid fa-circle-plus fa-spin fa-spin-reverse"></i>Add</button>
                    ...
                    <!-- Modal content  -->
                        <div class="modal-content">
                            ...
                            <form action="{{ route('add_class.storeLesson') }}" method="POST">
                                @csrf
                                <div>
                                    <div class="quarter" id="left-corner">
                                        <lable class="label-quarter">Quarter</label>
                                            <input class="ipt-quarter" type="text" name="quarter">
                                    </div>
                                    <div class="title" id="left-corner">
                                    ...
                                    <div>
                                        <label class="label-content">Class</label>
                                        <div class="content">
            <label class="label-content">Class</label>
            ...
            <div class="display-class-lesson">
            <h2>Lessons</h2>
            @if($classes_lessons->count() > 0)
                @foreach($classes_lessons as $rs)
                
                
                <div class="lesson">
                    <p class="title-of-lesson"> Title : {{ $rs->title }}</p>
                    <p>{{ $rs->topic }}</p>
                </div>
            @endforeach
                @else
