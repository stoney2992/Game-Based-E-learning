...
<div class="nav-bar">
    ...
    <div class="admin-container">
        ...
        <hr />
        <form action="{{ route('teacher_registration.update', $teachers->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="update-ipt">
                <div class="label-input">
                    <label>Name</label>
                    <input type="text" name="name" placeholder="Name" value="{{ $teachers->name }}" >
                </div>
                <div class="label-input">
                    <label>Email</label>
                    <input type="text" name="email" placeholder="Email" value="{{ $teachers->email }}" >
                </div>
                <div class="label-input">
                    <label>Phone</label>
                    <input type="text" name="phone" placeholder="Phone" value="{{ $teachers->phone }}" >
                </div>
                <div class="label-input">
                    <label>Password</label>
                    <input class="password" type="Password" name="password" placeholder="Password" value="{{ $teachers->password }}">
                </div>    
            </div>
