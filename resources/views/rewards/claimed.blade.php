...
<div class="nav-bar">
    ...
    <div class="container-dashboard">
       ...
       <div class="my-classes">
        ...
        <div class="container">
            <div class="claimed-title-head">
                 <h1 class="claimed-title">Claimed Rewards</h1>
            </div>
            <hr />
            <ul class="claimers">
                @forelse ($claimedRewards as $claimedReward)
                    <li class="list-claimers">
                        Reward: {{ $claimedReward->reward->name }} <br>
                        Claimed By: {{ $claimedReward->user->name }} <br>
                        Claimed On: {{ $claimedReward->created_at->format('M d, Y') }}
                    </li>
                @empty
